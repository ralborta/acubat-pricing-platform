...
export async function POST(request: NextRequest) {
  try {
    ...
    // Los datos hardcodeados han sido eliminados - ahora se leen del archivo Excel real
        categoria: 'Automotriz',
        tipo: 'Batería',
        gtia_meses: 18,
        bome: 'BOM',
      ...
      {
        codigo: 'MOU-008',
        descripcion: 'Batería Moura 70Ah 12V',
        precio_lista: 52000,
        c20_ah: 70,
        categoria: 'Automotriz',
        tipo: 'Batería',
      ...
      {
        codigo: 'MOU-009',
        descripcion: 'Batería Moura 90Ah 12V',
        precio_lista: 65000,
        c20_ah: 90,
        categoria: 'Automotriz',
        tipo: 'Batería',
      ...
      {
        codigo: 'MOU-010',
        descripcion: 'Batería Moura 110Ah 12V',
        precio_lista: 78000,
        c20_ah: 110,
        categoria: 'Automotriz',
        tipo: 'Batería',
